    ...
    <div class="sales-board-form">
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <el-input-number size="mini" v-model="num" @change="handleChange" :min="1" :max="10"
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
         <el-radio-group v-model="radio5" size="mini" fill="#4fc08d">
           <el-radio-button v-for="item in versionList" :label="item.value"  class="bbc">{{item.label}}</el-radio-button>
         </el-radio-group>
        </div>
      </div>
      <div class="sales-board-line">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <el-button type="primary" size="medium" class="bg">确认购买</el-button>
        </div>
      </div>
    </div>
...
<style scoped>
  .el-input-number__decrease !important{
  }

  .el-input-number__decrease button{
    background: red;
  }
